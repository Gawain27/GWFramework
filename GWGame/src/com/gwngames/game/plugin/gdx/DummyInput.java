...
public final class DummyInput implements Input {

    @Override public boolean isPeripheralAvailable(Peripheral peripheral) {
        return peripheral == Peripheral.HardwareKeyboard;
    }

    // --- implement what you need; return defaults for the rest ---
    ...
    @Override public Orientation getNativeOrientation() { return null; }
    ...
    @Override public void openTextInputField(NativeInputConfiguration config) {}
