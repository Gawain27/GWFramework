...
public enum DevelopmentCssAssets implements IAssetPath {
    DASHBOARD_DARK_CSS("css/dashboard-dark.css");

    private final String defaultPath;
    private final Map<String,String> localePaths;

    DevelopmentCssAssets(String path) {
        this.defaultPath = path;
        this.localePaths = Map.of();
    }
    DevelopmentCssAssets(String baseName, Map<String,String> localePaths) {
