...
public enum NeedleOFSilverAssets implements IAssetPath {
    ASSETS_TXT("assets.txt");

    private final String defaultPath;
    private final Map<String,String> localePaths;

    NeedleOFSilverAssets(String path) {
        this.defaultPath = path;
        this.localePaths = Map.of();
    }
    NeedleOFSilverAssets(String baseName, Map<String,String> localePaths) {
